...
![fig2](.pics/labX_manual_fig2-Copy.png)  
...
- **Power**: The total pwer consumption can be found from the **project_name_power_routed.rpt** file generated in the **project_name.runs/impl_1** foler. Report the "Summary" section in this file. 
- **Utilization**: The total area utilization can be found from the **project_name_utilization_placed.rpt** file generated in the **project_name.runs/impl_1** foler. Report the "Slice Logic" section in this file.   
