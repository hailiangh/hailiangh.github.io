...
- **Utilization**: The utilization report can be generated by clicking on **Reports -> Report Utilization**. Alternatively, the total area utilization can be found from the **project_name_utilization_placed.rpt** file generated in the **project_name.runs/impl_1** foler. Report the "Summary" section in this file.   
