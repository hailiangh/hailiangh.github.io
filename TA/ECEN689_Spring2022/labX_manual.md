...
- **Power**: The power report can be generated once the implementation is done. Click on **Reports -> Report Power** and a power report will show up. Alternatively, the total pwer consumption can be found from the **project_name_power_routed.rpt** file generated in the **project_name.runs/impl_1** foler. Report the "Summary" section in this file. 
- **Utilization**: The utilization report can be generated by clicking on **Reports -> Report Utilization**. Alternatively, the total area utilization can be found from the **project_name_utilization_placed.rpt** file generated in the **project_name.runs/impl_1** foler. Report the "Slice Logic" section in this file.   
